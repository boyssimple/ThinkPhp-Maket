                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Supermaket/admin.php/Systable/save">
                                                ...
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">oldName </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    
                                                        <?php if($model): ?><input type="text" id="oldName" name="oldName" value="<?php echo ($model["oldName"]); ?>"  required="required" class="form-control col-md-7 col-xs-12">
                                                            <?php else: ?>
                                                            <input type="text" id="oldName" name="oldName"  required="required" class="form-control col-md-7 col-xs-12"><?php endif; ?>
