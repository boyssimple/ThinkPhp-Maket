                            ...
                            <li><a><i class="fa fa-clone"></i>系统管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a>分组管理<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li class="sub_menu"><a href="/Supermaket/admin.php/Sysgroup/add">新增分组</a></li>
                                            <li class="sub_menu"><a href="/Supermaket/admin.php/Sysgroup/index">分组列表</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="/Supermaket/admin.php/User/index">用户管理</a></li>
                                    <li><a href="/Supermaket/admin.php/Sysmenu/index">资源管理</a></li>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>代码生成 <small>代码自动化生成工具</small></h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Supermaket/admin.php/Generation/handle">

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">表名称 </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="table" name="table" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">模块名称 </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="modalName" name="modalName"  required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
