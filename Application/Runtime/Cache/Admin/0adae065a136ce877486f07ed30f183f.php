                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-clone"></i>系统管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/Supermaket/admin.php/Group/index">分组管理</a></li>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <table id="datatable1" class="table table-striped table-bordered">
                                    <thead>
                                    <tr>
                                        <?php if(is_array($fields)): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><th><?php echo ($vo); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
...
<script src="/Supermaket/Public/Vendor/gentelella/build/js/custom.min.js"></script>
<script src="/Supermaket/Public/Admin//js/<?php echo ($tableLC); ?>.js"></script>
