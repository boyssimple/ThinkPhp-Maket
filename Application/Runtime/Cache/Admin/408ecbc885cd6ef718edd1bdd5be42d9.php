                            ...
                            <?php if( $m["children"] > 0 ): ?><ul class="nav child_menu">
                                    <?php if(is_array($m["children"])): $i = 0; $__LIST__ = $m["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ms): $mod = ($i % 2 );++$i;?><li><a  <?php if( $ms["menuUrl"] != '' ): ?>href="/Design/admin.php/<?php echo ($ms["menuUrl"]); ?>"<?php endif; ?> ><?php echo ($ms["name"]); if( $ms["children"] > 0 ): ?><span class="fa fa-chevron-down"></span><?php endif; ?></a>
                                            <?php if( $ms["children"] > 0 ): ?><ul class="nav child_menu">
                                                    <?php if(is_array($ms["children"])): $i = 0; $__LIST__ = $ms["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mss): $mod = ($i % 2 );++$i;?><li class="sub_menu"><a href="/Design/admin.php/<?php echo ($mss["menuUrl"]); ?>"><?php echo ($mss["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </ul><?php endif; ?>
...
<!-- /top navigation -->
        ...
        <div class="right_col" role="main">
            <div class="">
                ...
                <div class="row">
                    <?php if(is_array($tables)): foreach($tables as $key=>$table): ?><div class="col-md-3 col-xs-12 widget widget_tally_box">
                            <div class="x_panel fixed_height_390">
                                <div class="x_title">
                                    <h2><?php echo ($table["name"]); ?> (<?php echo ($table["remark"]); ?>)</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <ul class="legend list-unstyled">
                                        <?php if(is_array($table["columns"])): foreach($table["columns"] as $key=>$column): ?><li>
                                                <p>
                                                    <span class="icon"><i class="fa fa-square green"></i></span> <span class="name"><?php echo ($column["colName"]); ?></span>
                                                </p>
