            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>装修效果图 <small>装修效果图</small></h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate enctype="multipart/form-data"  method="post" data-parsley-validate class="form-horizontal form-label-left" action="/Design/admin.php/Effect/save">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <select class="form-control" id="styleId" name="styleId">
                                                            <?php if($styles): if(is_array($styles)): $i = 0; $__LIST__ = $styles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($model): if($model["styleId"] == $vo['id']): ?><option selected value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option>
                                                                        <?php else: ?>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">户型名称 </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="form-control" id="typeId" name="typeId">
                                                            <?php if($types): if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($model): if($model["typeId"] == $vo['id']): ?><option selected value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option>
                                                                            <?php else: ?>
                                                                            <option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endif; ?>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">空间 </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="form-control" id="spaceId" name="spaceId">
                                                            <?php if($spaces): if(is_array($spaces)): $i = 0; $__LIST__ = $spaces;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($model): if($model["spaceId"] == $vo['id']): ?><option selected value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option>
                                                                            <?php else: ?>
                                                                            <option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endif; ?>
...
<script>
    function delImg(id){
        ...
        if (window.confirm("确定删除？")){
            $.post(ENV + '/Effectimgs/delete',{id:id},function(result){
