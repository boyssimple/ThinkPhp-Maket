                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/Supermaket/admin.php/Sysgroup/save">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <?php if($model): ?><input type="text" id="groupName" name="groupName" value="<?php echo ($model["groupName"]); ?>"  required="required" class="form-control col-md-7 col-xs-12">
                                                            <?php else: ?>
                                                            <input type="text" id="groupName" name="groupName"  required="required" class="form-control col-md-7 col-xs-12"><?php endif; ?>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <?php if($model): ?><input type="text" id="parentId" name="parentId" value="<?php echo ($model["parentId"]); ?>"  required="required" class="form-control col-md-7 col-xs-12">
                                                            <?php else: ?>
                                                            <input type="text" id="parentId" name="parentId"  required="required" class="form-control col-md-7 col-xs-12"><?php endif; ?>
