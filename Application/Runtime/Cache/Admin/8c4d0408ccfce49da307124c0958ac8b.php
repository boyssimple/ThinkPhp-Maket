<?php if (!defined('THINK_PATH')) exit();?>$(function(){
    $('#datatable1').DataTable({
        ...
        aoColumns : [//服务器返回的数据处理 此时返回的是 {}
            <?php if(is_array($fields)): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>{ "mData": "<?php echo ($vo); ?>","sWidth": 250},<?php endforeach; endif; else: echo "" ;endif; ?>
