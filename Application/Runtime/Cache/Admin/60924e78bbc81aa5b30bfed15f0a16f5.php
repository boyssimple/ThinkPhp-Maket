            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>滚动图 <small>滚动图</small></h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate enctype="multipart/form-data"  method="post" class="form-horizontal form-label-left" action="/Design/admin.php/Gallery/save">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">图片 </label>
                                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                                         <input type="file" name="url" id="url" class="form-control col-md-7 col-xs-12" />
                                                     </div>
                                                </div>
                                                <?php if($model): if($model["url"] != '' ): ?><div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"> </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <img class="img-responsive avatar-view" src="/Design/Uploads/<?php echo ($model["url"]); ?>" alt="Avatar" title="Change the avatar" style = "max-height: 200px;">
                                                            </div>
                                                        </div><?php endif; endif; ?>
                                                <div class="form-group">
