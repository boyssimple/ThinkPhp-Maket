            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>系统信息 <small>系统信息</small></h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate enctype="multipart/form-data"  method="post" class="form-horizontal form-label-left" action="/Design/admin.php/System/save">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <?php if($model): ?><input type="text" id="sysVision" name="sysVision" value="<?php echo ($model["sysVision"]); ?>" required="required" class="form-control col-md-7 col-xs-12">
                                                        <?php else: ?>
                                                        <input type="text" id="sysVision" name="sysVision" required="required" class="form-control col-md-7 col-xs-12"><?php endif; ?>
                                                </div>
                                            </div>
                                            ...
                                            <?php if($model): if($model["favicon"] != '' ): ?><div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <img class="img-responsive avatar-view" src="/Design/Uploads/<?php echo ($model["favicon"]); ?>" alt="Avatar" title="Change the avatar" style = "max-height: 200px;">
                                                        </div>
                                                    </div><?php endif; endif; ?>
                                            <div class="form-group">
