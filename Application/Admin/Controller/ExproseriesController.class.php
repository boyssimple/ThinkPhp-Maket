...
class ExproseriesController extends CommonController {
    ...
    public function save(){
        if (IS_GET){
            ...
            if (empty($id)){
                $model->data($data)->add();
                $this->success('新增成功!', __APP__.'/Exproseries/add');
            }else{
                $model->data($data)->save();
                $this->success('修改成功!', __APP__.'/Exproseries/index');
            }
        }else{
            $this->error('参数传递错误!', __APP__.'/Exproseries/add');
        }
    }
